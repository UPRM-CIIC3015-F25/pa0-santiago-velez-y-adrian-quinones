...
def ball_movement(ball_speed=None, hit_sound=None):
    """
    ...
    # Done Task 5 Create a Merge Conflict (Santiago Velez Cruz & Adrián Quiñones Pérez)
    speed = 5
    if start:
...
while True:
    # Event handling
    # DONE Task 4: Add your name (Santiago Vélez Cruz and Adrián E. Quiñones Pérez) (Seen in screenshots)
    name = "John Doe"
